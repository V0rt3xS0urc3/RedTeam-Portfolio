# 🐧 DevOps Lab v1.0 FINAL

## 👨‍💻 Autor
**Diego Arriagada Zamora**
- 💼 [LinkedIn](https://www.linkedin.com/in/diegoarriagadazamora)
- 🐙 [GitHub](https://github.com/V0rt3xS0urc3)
...
**"Crear un laboratorio DevOps completo, offline y portable, que permita practicar comandos y conceptos de todas las áreas de DevOps en un solo archivo HTML, sin necesidad de internet ni instalaciones."**
...
Este proyecto nació de una necesidad real: **quedé sin internet por aproximadamente 4 días** y no tenía acceso a las famosas páginas de práctica como:

- [Docker Playground](https://labs.play-with-docker.com/)
- [SudoAprende](https://sudoaprende.com/)
- [Katacoda / O'Reilly](https://www.katacoda.com/)
...
**DevOps Lab v1.0** es un proyecto creado por y para la comunidad DevOps. Nació de una necesidad real y se convirtió en un laboratorio completo que permite aprender y practicar DevOps desde cualquier lugar, sin necesidad de internet ni instalaciones complejas.

**"La mejor manera de aprender DevOps es haciendo. Y ahora puedes hacerlo en cualquier lugar."**

---

## 📎 Enlaces

- **Repositorio:** [GitHub - V0rt3xS0urc3/RedTeam-Portfolio](https://github.com/V0rt3xS0urc3/RedTeam-Portfolio/tree/main/DevopsLabs)
- **Autor:** [Diego Arriagada Zamora](https://www.linkedin.com/in/diegoarriagadazamora)

---

*"El conocimiento no debe depender de la conexión a internet."* — DevOps Lab v1.0
